...
SEGMENTS = [
    ...
    dict(
        ...
        title='终极考核：笔试 + AI 实战', sub='先过知识点，再打一通完整的电话',
        body=cards([
            ('🎭 角色设定', '你是豌豆思维班主任；家长是乐乐妈妈，孩子 7 岁、小学一年级、S3 在读'),
            ('⚠️ 家长的两个顾虑', '① 觉得没有看到明显效果 ② 觉得价格贵，还想跟爸爸商量'),
            ('📝 考核构成（三项全过）', '5 道综合选择题（串行作答）+ 3 道填空题（关键词作答）+ AI 家长自由对话'),
            ('📊 评分维度', '共情与关系 25 · 异议识别与诊断 25 · 方案与说服 30 · 闭环与合规 20'),
        ], style='warn'),
        narr='最后一章是终极考核，由三个部分组成，三项全部通过才算完成。'
             '第一部分是五道综合选择题，会跨章检验你对关键动作的掌握，包括课时还多时的第一步、'
             '效果异议里哪些做法是错的、爸爸不同意时怎么判断真假异议、价格异议的最后一手优惠，'
             '以及眼睛顾虑该归到哪一步。第二部分是三道填空题，检验你对四步法顺序、'
             'S4 级别课时数、以及课程内容占比这些关键数字的记忆。'
             '完成这两项之后，第三部分才是 AI 家长自由对话。'
             '你的角色是豌豆思维班主任，家长是乐乐妈妈，孩子七岁、刚上小学一年级、豌豆 S3 在读。'
             '乐乐妈妈有两个主要顾虑：一是觉得没有看到明显的效果，二是觉得价格贵，还想跟爸爸商量。'
             '对话至少四轮，建议六到八轮。AI 评分从四个维度进行：共情与关系二十五分，'
             '异议识别与诊断二十五分，方案与说服三十分，闭环与合规二十分。'
